...
def weibo_hot(url):
    ...
    print('DateTime:' + crawltime + ' weibo hot rank data has downloaded')
...
def baidu_hot(url):
    ...
    print('DateTime:' + crawltime + ' baidu hot rank data has downloaded')
...
def zhihu_hot(url):
    ...
    print('DateTime:' + crawltime + ' zhihu hot rank data has downloaded')
